...
, mSecondPassTextures()
{
	...
	mShaders.load(Shaders::GaussianBlurPass, "media/shaders/fullPass.vert", "media/shaders/gaussianBlur.frag");
		...
		sf::RenderTarget& output)
{
	...
	add(mFirstPassTextures[0], mSecondPassTextures[0],
...
void BloomEffect::add(const sf::RenderTexture& source, const
